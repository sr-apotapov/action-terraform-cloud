 ...
 * @param tfApiToken
 */
function getJsonPlan(planOutput, tfOrg, tfApiToken) {
    return __awaiter(this, void 0, void 0, function* () {
        const planApiUrl = getPlanApiUrl(planOutput, tfOrg);
        const planResult = yield axios_1.default.get(planApiUrl, {
            headers: {
                accept: 'application/json',
                authorization: `Bearer ${tfApiToken}`
            }
        });
        const result = yield axios_1.default.get(`https://app.terraform.io${planResult.data.data.links['json-output']}`, {
            headers: {
                accept: 'application/json',
                authorization: `Bearer ${tfApiToken}`
            }
...
exports.getJsonPlan = getJsonPlan;
...
async function run () {
    return __awaiter(this, void 0, void 0, async function* () {
        try {
            ...
            // TERRAFORM FMT //
            const fmt = console.log(await exec('terraform fmt -check -diff', (error, stdout, stderr) => {
